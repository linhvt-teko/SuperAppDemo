...
#ifndef ICHECKLOYALTYUI_SWIFT_H
#define ICHECKLOYALTYUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ICheckLoyaltyUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class ICULazyImageNode;
@class ASLayoutSpec;

SWIFT_CLASS("_TtC15ICheckLoyaltyUI29ICLoyaltyInputBannerContainer")
@interface ICLoyaltyInputBannerContainer : ICUDisplayNode
@property (nonatomic, readonly, strong) ICULazyImageNode * _Nonnull bannerNode;
- (void)didLoad;
...
@interface ICLoyaltyInputBannerContainer (SWIFT_EXTENSION(ICheckLoyaltyUI)) <UITextFieldDelegate>
...
SWIFT_CLASS("_TtC15ICheckLoyaltyUI13ILUAlertPopup")
@interface ILUAlertPopup : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC15ICheckLoyaltyUI16ILUGradientColor")
@interface ILUGradientColor : UIColor
...
SWIFT_CLASS("_TtC15ICheckLoyaltyUI26ILUMemberPointSuccessPopup")
@interface ILUMemberPointSuccessPopup : ICUDisplayNode
- (ASLayoutSpec * _Nonnull)layoutSpecThatFits:(ASSizeRange)constrainedSize SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Custom font theme to display
SWIFT_CLASS("_TtC15ICheckLoyaltyUI12ILUThemeFont")
@interface ILUThemeFont : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
